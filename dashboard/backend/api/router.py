...
from dashboard.backend.api.routers.discord_integration import router as discord_integration_router
...
api_router.include_router(discord_integration_router)
