...
export function Navbar() {
  return (
    <nav className="landing-header fixed top-0 left-0 right-0 z-50 border-b border-border bg-background/80 backdrop-blur-md">
      <div className="hidden md:flex items-center gap-3 text-[15px] font-semibold text-muted-foreground min-w-0 justify-self-start">
        {NAV_LINKS.map((link) => (
      ...
      <Link href="/" className="brand-lockup justify-self-center">
